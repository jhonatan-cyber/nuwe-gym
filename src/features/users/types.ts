...
export const ROLES_INFO: RoleInfo[] = [
  {
    ...
    label: 'Administrador',
    description:
      'Acceso total al sistema. Puede gestionar usuarios, configuraciones, finanzas y todos los módulos.',
    permissions: [
  ...
  },
  {
    ...
    label: 'Recepcionista',
    description:
      'Acceso a recepción, caja y atención al socio. No puede modificar configuraciones del sistema.',
    permissions: [
      'Gestión de Socios (CRUD)',
      'Suscripciones y Renovaciones',
      'Punto de Venta (POS)',
  ...
  },
  {
    ...
    label: 'Entrenador',
    description:
      'Acceso limitado solo a check-ins, clases y visualización de información de socios.',
    permissions: [
      'Ver Socios',
      'Check-ins',
      'Clases',
