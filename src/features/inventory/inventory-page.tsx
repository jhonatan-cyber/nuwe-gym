...
export function InventoryPage() {
  ...
  function openEditModal(prod: any) {
    ...
    setForm({
      ...
      stockCurrent: prod.stockCurrent.toString(),
      stockMinimum: prod.stockMinimum.toString(),
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-bold text-primary">
                {formatCurrency(catStats?.avgSalePrice || 0)}
              </span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-[10px] text-muted-foreground font-bold">
            ...
            <div className="flex items-center justify-between">
              ...
              <span
                className={`text-xs font-bold ${(catStats?.outOfStock || 0) > 0 ? 'text-red-500' : 'text-emerald-500'}`}
              >
                {catStats?.outOfStock || 0}
              </span>
            </div>
                  ...
                  <div className="grid grid-cols-2 gap-2 max-h-[440px] overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] scrollbar-none">
                    ...
                    {categories
                      ...
                      .map((cat) => {
                        ...
                        const maxStock =
                          catProds.length > 0
                            ? Math.max(...catProds.map((p: any) => p.stock), 1)
                            : 1
