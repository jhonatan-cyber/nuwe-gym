...
export function PackageForm({ editingPackageId, onBack }: PackageFormProps) {
  ...
  function addItem() {
    setFormData({
      ...formData,
      items: [...formData.items, { description: '', sortOrder: formData.items.length }],
    })
  }
    ...
    >
      <div className="bg-card p-6 rounded-[2rem] border border-border/10 shadow-xl overflow-y-auto max-h-full">
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-6">
          ...
          <div className="grid gap-2">
            <Label htmlFor="pkg-desc" className="text-xs font-bold">Descripcion</Label>
            <Textarea
              id="pkg-desc"
          ...
          <div className="grid gap-3">
            <div className="flex items-center justify-between">
              ...
              <Button type="button" variant="ghost" size="sm" onClick={addItem} className="text-xs font-bold h-7">
            ...
            {formData.items.length === 0 ? (
              <div className="text-center py-6 rounded-2xl border border-dashed dark:border-white/10 border-black/10">
                <p className="text-xs text-muted-foreground">Sin beneficios configurados</p>
                <Button type="button" variant="ghost" size="sm" onClick={addItem} className="text-xs font-bold mt-2 h-7">
